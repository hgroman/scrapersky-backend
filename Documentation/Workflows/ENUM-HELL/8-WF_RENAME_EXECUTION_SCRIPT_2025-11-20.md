# AUTOMATED RENAMING SCRIPT – Run on November 20, 2025

Save as `wf_rename_atomic.py` in project root and execute.
...
print("\nRun: ruff check --fix .   then commit in 4 batches")


Commit order after script:

models
services/background + crm
routers
main.py lifespan imports (see previous message for exact lines)