...
def upgrade() -> None:
    ...
    op.drop_table("tasks")
    op.alter_column("batch_jobs", "batch_id", existing_type=sa.UUID(), nullable=False)
    op.create_index(
        op.f("ix_batch_jobs_batch_id"), "batch_jobs", ["batch_id"], unique=True
    )
    ...
    op.create_foreign_key(
        None, "domains", "batch_jobs", ["batch_id"], ["batch_id"], ondelete="SET NULL"
    )
    ...
    op.add_column(
        "feature_flags", sa.Column("is_enabled", sa.Boolean(), nullable=False)
    )
    op.alter_column(
        "feature_flags",
        "name",
    ...
    op.create_foreign_key(
        None, "jobs", "batch_jobs", ["batch_id"], ["batch_id"], ondelete="SET NULL"
    )
    ...
    op.drop_constraint(
        "local_businesses_place_id_key", "local_businesses", type_="unique"
    )
    op.drop_index("ix_local_businesses_place_id", table_name="local_businesses")
    op.create_index(
        op.f("ix_local_businesses_place_id"),
        "local_businesses",
        ["place_id"],
        unique=True,
    )
    op.create_index(
        op.f("ix_local_businesses_business_name"),
        "local_businesses",
        ["business_name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_local_businesses_city"), "local_businesses", ["city"], unique=False
    )
    op.create_index(
        op.f("ix_local_businesses_state"), "local_businesses", ["state"], unique=False
    )
    op.create_index(
        op.f("ix_local_businesses_tenant_id"),
        "local_businesses",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_local_businesses_zip"), "local_businesses", ["zip"], unique=False
    )
    op.alter_column(
        "place_searches",
        "params",
    ...
    op.create_index(
        op.f("ix_place_searches_tenant_id"),
        "place_searches",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.alter_column(
        "places_staging", "tenant_id", existing_type=sa.UUID(), nullable=False
    )
    op.alter_column(
        "places_staging", "created_by", existing_type=sa.UUID(), nullable=True
    )
    op.alter_column(
        "places_staging",
        "user_name",
    ...
    op.create_index(
        op.f("ix_places_staging_deep_scan_status"),
        "places_staging",
        ["deep_scan_status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_places_staging_place_id"), "places_staging", ["place_id"], unique=True
    )
    op.create_index(
        op.f("ix_places_staging_tenant_id"),
        "places_staging",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.drop_constraint(
        "sidebar_features_requires_feature_fkey", "sidebar_features", type_="foreignkey"
    )
    op.create_foreign_key(
        None, "sidebar_features", "tenants", ["tenant_id"], ["id"], ondelete="SET NULL"
    )
    ...
    op.create_index(
        op.f("ix_sitemap_files_domain_id"), "sitemap_files", ["domain_id"], unique=False
    )
    op.create_index(
        op.f("ix_sitemap_files_job_id"), "sitemap_files", ["job_id"], unique=False
    )
    op.create_index(
        op.f("ix_sitemap_files_tenant_id"), "sitemap_files", ["tenant_id"], unique=False
    )
    op.drop_constraint(
        "sitemap_files_user_id_fkey", "sitemap_files", type_="foreignkey"
    )
    op.drop_constraint(
        "sitemap_files_domain_id_fkey", "sitemap_files", type_="foreignkey"
    )
    op.drop_constraint(
        "sitemap_files_updated_by_fkey", "sitemap_files", type_="foreignkey"
    )
    op.drop_constraint(
        "sitemap_files_created_by_fkey", "sitemap_files", type_="foreignkey"
    )
    ...
    op.create_index(
        op.f("ix_sitemap_urls_sitemap_id"), "sitemap_urls", ["sitemap_id"], unique=False
    )
    op.create_index(
        op.f("ix_sitemap_urls_tenant_id"), "sitemap_urls", ["tenant_id"], unique=False
    )
    op.drop_constraint(
        "sitemap_urls_domain_id_fkey", "sitemap_urls", type_="foreignkey"
    )
    op.drop_constraint(
        "sitemap_urls_updated_by_fkey", "sitemap_urls", type_="foreignkey"
    )
    op.drop_constraint(
        "sitemap_urls_created_by_fkey", "sitemap_urls", type_="foreignkey"
    )
...
def downgrade() -> None:
    ...
    op.add_column(
        "sitemap_urls",
        sa.Column("news_count", sa.INTEGER(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "sitemap_urls",
    ...
    op.add_column(
        "sitemap_urls",
        sa.Column("loc_text", sa.TEXT(), autoincrement=False, nullable=False),
    )
    op.add_column(
        "sitemap_urls",
    ...
    op.create_foreign_key(
        "sitemap_urls_domain_id_fkey", "sitemap_urls", "domains", ["domain_id"], ["id"]
    )
    ...
    op.create_index(
        "idx_sitemap_urls_tenant_domain",
        "sitemap_urls",
        ["tenant_id", "domain_id"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_sitemap_urls_sitemap_id", "sitemap_urls", ["sitemap_id"], unique=False
    )
    op.alter_column(
        "sitemap_urls",
        "updated_at",
    ...
    op.create_index(
        "idx_sitemap_files_tenant_domain",
        "sitemap_files",
        ["tenant_id", "domain_id"],
        unique=False,
    )
    op.create_index(
        "idx_sitemap_files_status", "sitemap_files", ["status"], unique=False
    )
    op.alter_column(
        "sitemap_files",
        "updated_at",
    ...
    op.create_foreign_key(
        "sidebar_features_requires_feature_fkey",
        "sidebar_features",
        "feature_flags",
        ["requires_feature"],
        ["id"],
    ...
    op.create_foreign_key(
        "profiles_role_id_fkey", "profiles", "roles", ["role_id"], ["id"]
    )
    op.create_foreign_key(
        "profiles_id_fkey",
        "profiles",
    ...
    op.drop_index(
        op.f("ix_places_staging_deep_scan_status"), table_name="places_staging"
    )
    op.create_unique_constraint(
        "places_staging_place_id_key", "places_staging", ["place_id"]
    )
    op.create_index(
        "idx_places_staging_tenant", "places_staging", ["tenant_id"], unique=False
    )
    op.create_index(
        "idx_places_staging_status", "places_staging", ["status"], unique=False
    )
    op.alter_column(
        "places_staging",
        "updated_at",
    ...
    op.alter_column(
        "places_staging", "created_by", existing_type=sa.UUID(), nullable=False
    )
    op.alter_column(
        "places_staging", "tenant_id", existing_type=sa.UUID(), nullable=True
    )
    op.alter_column(
        "places_staging",
        "vicinity",
    ...
    op.drop_index(
        op.f("ix_local_businesses_business_name"), table_name="local_businesses"
    )
    op.drop_index(op.f("ix_local_businesses_place_id"), table_name="local_businesses")
    op.create_index(
        "ix_local_businesses_place_id", "local_businesses", ["place_id"], unique=False
    )
    op.create_unique_constraint(
        "local_businesses_place_id_key", "local_businesses", ["place_id"]
    )
    op.create_index(
        "idx_local_businesses_tenant_id",
        "local_businesses",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.add_column(
        "jobs", sa.Column("id_uuid", sa.UUID(), autoincrement=False, nullable=True)
    )
    op.add_column(
        "jobs",
        sa.Column(
    ...
    op.add_column(
        "jobs",
        sa.Column("batch_id_string", sa.VARCHAR(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "jobs",
        sa.Column(
    ...
    op.add_column(
        "domains",
        sa.Column("market_segment", sa.TEXT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "domains",
        sa.Column("has_ecommerce", sa.BOOLEAN(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "domains",
        sa.Column("has_yoast_seo", sa.BOOLEAN(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "domains",
        sa.Column(
    ...
    op.add_column(
        "domains",
        sa.Column("google_analytics_id", sa.TEXT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "domains",
        sa.Column(
    ...
    op.add_column(
        "domains",
        sa.Column("cdn_provider", sa.TEXT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "domains",
        sa.Column("wordpress_theme", sa.TEXT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "domains",
        sa.Column(
            "content_scrape_error", sa.TEXT(), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "domains",
        sa.Column("has_ssl", sa.BOOLEAN(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "domains",
        sa.Column("ssl_issuer", sa.TEXT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "domains",
        sa.Column(
    ...
    op.add_column(
        "domains",
        sa.Column(
            "average_page_size", sa.INTEGER(), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "domains",
        sa.Column("robots_txt", sa.TEXT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "domains",
        sa.Column(
            "google_tag_manager_id", sa.TEXT(), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "domains",
    ...
    op.add_column(
        "domains",
        sa.Column("page_scrape_error", sa.TEXT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "domains",
        sa.Column(
            "agency_sitemap_analysis_done_at",
            postgresql.TIMESTAMP(timezone=True),
            autoincrement=False,
            nullable=True,
        ),
    ...
    op.add_column(
        "domains",
        sa.Column("business_category", sa.TEXT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "domains",
        sa.Column(
    ...
    op.add_column(
        "domains",
        sa.Column("primary_language", sa.TEXT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "domains",
        sa.Column(
    ...
    op.add_column(
        "domains",
        sa.Column(
            "agency_copyright_status", sa.TEXT(), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "domains",
        sa.Column("industry_vertical", sa.TEXT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "domains",
        sa.Column(
            "server_response_time", sa.INTEGER(), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "domains",
        sa.Column(
            "has_cookie_notice", sa.BOOLEAN(), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "domains",
        sa.Column(
            "total_images_count", sa.INTEGER(), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "domains",
        sa.Column(
            "agency_sitemap_analysis_done",
            sa.TEXT(),
            autoincrement=False,
            nullable=True,
        ),
    ...
    op.add_column(
        "domains",
        sa.Column(
            "has_contact_form7", sa.BOOLEAN(), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "domains",
        sa.Column("competitor_group", sa.TEXT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "domains",
        sa.Column(
    ...
    op.add_column(
        "domains",
        sa.Column("monitoring_status", sa.TEXT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "domains",
        sa.Column("has_sitemap", sa.BOOLEAN(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "domains",
        sa.Column("copyright_year", sa.TEXT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "domains",
        sa.Column(
            "has_privacy_policy", sa.BOOLEAN(), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "domains",
        sa.Column(
            "agency_ad_performance_at",
            postgresql.TIMESTAMP(timezone=True),
            autoincrement=False,
            nullable=True,
        ),
    ...
    op.add_column(
        "domains",
        sa.Column("hosting_location", sa.TEXT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "domains",
        sa.Column(
    ...
    op.add_column(
        "domains",
        sa.Column(
            "sitemap_monitor_error", sa.TEXT(), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "domains",
        sa.Column("has_woocommerce", sa.BOOLEAN(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "domains",
        sa.Column(
    ...
    op.add_column(
        "domains",
        sa.Column(
            "agency_wordpress_details", sa.TEXT(), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "domains",
    ...
    op.add_column(
        "domains",
        sa.Column("has_wpforms", sa.BOOLEAN(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "domains",
        sa.Column("has_divi", sa.BOOLEAN(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "domains",
        sa.Column(
    ...
    op.add_column(
        "domains",
        sa.Column("hosting_provider", sa.TEXT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "domains",
        sa.Column("server_type", sa.TEXT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "domains",
        sa.Column(
            "agency_ad_performance_status",
            sa.TEXT(),
            autoincrement=False,
            nullable=True,
        ),
    ...
    op.add_column(
        "domains",
        sa.Column("ssl_version", sa.TEXT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "domains",
        sa.Column("lead_source", sa.TEXT(), autoincrement=False, nullable=True),
    ...
    op.add_column(
        "domains",
        sa.Column(
            "average_response_time", sa.INTEGER(), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "domains",
    ...
    op.add_column(
        "domains",
        sa.Column("elementor_version", sa.TEXT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "domains",
        sa.Column(
    ...
    op.add_column(
        "domains",
        sa.Column("sitemap_url", sa.TEXT(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "domains",
        sa.Column(
            "agency_copyright_status_at",
            postgresql.TIMESTAMP(timezone=True),
            autoincrement=False,
            nullable=True,
        ),
    ...
    op.create_index(
        "idx_domains_sitemap_monitor_status",
        "domains",
        ["sitemap_monitor_status"],
        unique=False,
    )
    op.create_index(
        "idx_domains_page_scrape_status",
        "domains",
        ["page_scrape_status"],
        unique=False,
    )
    op.create_index(
        "idx_domains_industry_vertical", "domains", ["industry_vertical"], unique=False
    )
    op.create_index(
        "idx_domains_hosting_provider", "domains", ["hosting_provider"], unique=False
    )
    ...
    op.create_index(
        "idx_domains_country_code", "domains", ["country_code"], unique=False
    )
    op.create_index(
        "idx_domains_content_scrape_status",
        "domains",
        ["content_scrape_status"],
        unique=False,
    )
    op.create_index(
        "idx_domains_business_type", "domains", ["business_type"], unique=False
    )
    op.create_index(
        "idx_domains_business_category", "domains", ["business_category"], unique=False
    )
    ...
    op.add_column(
        "batch_jobs",
        sa.Column(
            "batch_id_original", sa.VARCHAR(), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "batch_jobs",
    ...
    op.alter_column("batch_jobs", "batch_id", existing_type=sa.UUID(), nullable=True)
    op.create_table(
        "tasks",
        sa.Column(
            "id",
        ...
        sa.ForeignKeyConstraint(
            ["domain_id"], ["domains.id"], name="tasks_domain_id_fkey"
        ),
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "user_id", "role_id", name="user_roles_user_id_role_id_key"
        ),
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["feature_id"],
            ["feature_flags.id"],
            name="tenant_features_feature_id_fkey",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["tenant_id"],
        ...
        sa.UniqueConstraint(
            "tenant_id", "feature_id", name="tenant_features_tenant_id_feature_id_key"
        ),
    )
    op.create_table(
        "task_analytics",
        ...
        sa.Column(
            "performance_score", sa.NUMERIC(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "meta_json",
            postgresql.JSONB(astext_type=sa.Text()),
    ...
    op.create_index(
        "idx_task_analytics_tenant_id", "task_analytics", ["tenant_id"], unique=False
    )
    op.create_index(
        "idx_task_analytics_task_id", "task_analytics", ["task_id"], unique=False
    )
    op.create_table(
        "task_history",
        sa.Column(
        ...
        sa.Column(
            "previous_assigned_to", sa.UUID(), autoincrement=False, nullable=True
        ),
    ...
    op.create_index(
        "idx_task_history_tenant_id", "task_history", ["tenant_id"], unique=False
    )
    op.create_index(
        "idx_task_history_task_id", "task_history", ["task_id"], unique=False
    )
    op.create_table(
        "migration_logs",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["requested_by"], ["auth.users.id"], name="features_requested_by_fkey"
        ),
        sa.ForeignKeyConstraint(
            ["reviewed_by"], ["auth.users.id"], name="features_reviewed_by_fkey"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "user_ratings_total", sa.INTEGER(), autoincrement=False, nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["domain_id"], ["domains.id"], name="pages_domain_id_fkey"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "tenant_id", sa.VARCHAR(length=255), autoincrement=False, nullable=True
        ),
        sa.Column("status", sa.VARCHAR(length=50), autoincrement=False, nullable=True),
        sa.Column(
            "job_type", sa.VARCHAR(length=50), autoincrement=False, nullable=True
        ),
        sa.Column(
