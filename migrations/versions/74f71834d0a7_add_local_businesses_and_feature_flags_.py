"""Add local_businesses and feature_flags models, other changes

Revision ID: 74f71834d0a7
Revises:
Create Date: 2025-04-02 14:56:55.452004
...
def upgrade() -> None:
    ...
    op.add_column("local_businesses", sa.Column("place_id", sa.String(), nullable=True))
...
def downgrade() -> None:
    ...
    op.drop_column("local_businesses", "place_id")
    op.add_column(
        "jobs",
        sa.Column(
            "started_at",
