# Routers Referenced in src/main.py
...
1.  `src/routers/batch_page_scraper.py` [NOVEL]
2.  `src/routers/batch_sitemap.py` [NOVEL]
3.  `src/routers/db_portal.py` [NOVEL]
4.  `src/routers/dev_tools.py` [NOVEL]
5.  `src/routers/domains.py` [NOVEL]
    - **5A. Domain Scheduler (Background Service)** (`src/services/domain_scheduler.py`):
    ...
    - **5A(b). Domain Sitemap Submission Scheduler (Background Service)** (`src/services/domain_sitemap_submission_scheduler.py`):
...
6.  `src/routers/email_scanner.py` [NOVEL]
7.  `src/routers/google_maps_api.py` [NOVEL]
8.  `src/routers/local_businesses.py` [NOVEL]
    - **8A. Local Business Enrichment (Background Service)** (`src/services/places/places_search_service.py`):
...
9.  `src/routers/modernized_page_scraper.py` [NOVEL]
10. `src/routers/modernized_sitemap.py` [NOVEL]
    - **10A. Sitemap Scheduler (Background Service)** (`src/services/sitemap_scheduler.py`):
    ...
    - **10A(b). Sitemap Deep Scan Jobs (Background Service)** (`src/services/sitemap_scheduler.py`):
