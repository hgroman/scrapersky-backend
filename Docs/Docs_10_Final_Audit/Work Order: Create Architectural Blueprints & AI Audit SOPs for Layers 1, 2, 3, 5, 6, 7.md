...
2.  **`Docs/Docs_6_Architecture_and_Status/CONVENTIONS_AND_PATTERNS_GUIDE.md`**: Contains detailed, prescriptive naming conventions and structural patterns for components across various layers (especially Layers 1, 2, 3, 4, and 5). This is critical for defining specific, auditable criteria.
