...
1. **Architectural Guides**
   - [Absolute ORM Requirement](/Docs/Docs_1_AI_GUIDES/01-ABSOLUTE_ORM_REQUIREMENT.md)
   - [Transaction Management Patterns](/Docs/Docs_7_Reference/07-04-transaction-patterns-reference.md)
   - [API Version Standardization](/Docs/Docs_1_AI_GUIDES/06-05-API-VERSION-STANDARDIZATION.md)

2. **Workflow Standards**
   - [Q&A Key Insights](/Docs/Docs_6_Architecture_and_Status/Q&A_Key_Insights.md)
   - [Workflow Audit Journal](/Docs/Docs_7_Workflow_Canon/Audit/WORKFLOW_AUDIT_JOURNAL.md)
