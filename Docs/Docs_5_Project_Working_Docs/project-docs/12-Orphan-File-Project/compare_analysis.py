...
# Show results
print("\n" + "="*60)
print(f"CRITICAL ISSUE: Found {len(critical_components)} scheduler components incorrectly marked as orphaned:")
print("="*60)

for comp in critical_components:
    print(f"\n- {comp['file']}")
    print(f"  * Standard analysis: Marked as orphaned with {comp['orphan_confidence']}% confidence")
    print(f"  * Enhanced analysis: Actually a SCHEDULER with {comp['scheduler_confidence']}% confidence")
