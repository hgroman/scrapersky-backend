        ...
        for fname in files:
            ...
            try:
                with open(path, 'r', encoding='utf-8') as f: # Specify encoding
                     tree = ast.parse(f.read(), filename=path) # Pass filename for better errors
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out', default='reports/scheduler_jobs.json', help='Output JSON file (relative to project root)')
